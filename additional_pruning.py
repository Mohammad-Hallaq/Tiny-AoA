...
data_folder = "/home/mohammad.hallaq/workarea/MobileNet_compression/r22_august8_beam_dataset_qualified" 
checkpoint_filename = 'pruning'
original_model_checkpoint = 'august8_beam.ckpt'
...
def prune_model(model, prune_method, prune_amount, train_loader, val_loader):
    ...
    elif prune_method == 'channel_pruning_magnitude_importance':
...
pruned_model = torch.load('/home/mohammad.hallaq/workarea/MobileNet_compression/model_pruned_channel_pruning_Taylor_importance_amount_0.87(74042).pth')
rf_classifier = RFClassifier(pruned_model)
rf_classifier.eval()
...
pruning_methods = ['channel_pruning_magnitude_importance'] #, 'filter_pruning', 'layer_pruning']
pruning_amounts = [0.7]  
...
torch.save(pruned_model.state_dict(), 'original_model.pth')